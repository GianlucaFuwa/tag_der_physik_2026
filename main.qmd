...
**Entwicklung & Analyse von Simulationen** ![](codesnippet.png){width="700" height="400"}
:::

::: {.fragment .fade-in-then-out fragment-index=2 style="text-align: center;"}
**Veröffentlichung und Lesen von Artikeln** ![](papersnippet.png){width="800" height="450"}
:::
