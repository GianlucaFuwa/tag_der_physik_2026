...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{particlephysics.jpg}
...
{\centering \includegraphics[width=0.63\linewidth,height=\textheight,keepaspectratio]{standardmodel.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{index_files/mediabag/Quark_structure_proton.pdf}
...
\includegraphics[width=6.25in,height=4.16667in]{codesnippet.png}

\textbf{Veröffentlichung und Lesen von Artikeln}
\includegraphics[width=7.29167in,height=4.6875in]{papersnippet.png}
